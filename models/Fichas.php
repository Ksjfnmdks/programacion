 ...
 * @property string $instrcutor_lider
...
class Fichas extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['codigo', 'fecha_incio', 'fecha_final', 'pro_id_FK', 'instrcutor_lider', 'jor_id_FK'], 'required'],
            [['fecha_incio', 'fecha_final', 'fecha_creacion'], 'safe'],
            [['pro_id_FK', 'jor_id_FK'], 'integer'],
            [['codigo'], 'string', 'max' => 10],
            [['instrcutor_lider'], 'string', 'max' => 100],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'pro_id_FK' => 'Pro Id Fk',
            'instrcutor_lider' => 'Instrcutor Lider',
            'jor_id_FK' => 'Jor Id Fk',
